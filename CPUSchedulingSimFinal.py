...
def create_gui():
    ...
    def display_results(results):
        ...
        columns = ("PID", "Completion Time", "Turnaround Time", "Waiting Time", "Response Time")
    ...
    algorithm_dropdown['values'] = ("FCFS", "SJF", "Priority", "Round Robin")
    algorithm_dropdown.grid(row=6, column=0, columnspan=2)
    
    tk.Button(root, text="Run Scheduler", command=run_scheduler).grid(row=6, column=2)
    root.mainloop()
